...
class InstaFollower:
    ...
    def find_followers(self):
        ...
        time.sleep(2)
        followers = self.driver.find_element(By.XPATH, '//*[@id="react-root"]/div/div/section/main/div/header/section/ul/li[2]/a')
        followers.click()
    ...
    def follow(self):
        all_buttons = self.driver.find_elements(By.CSS_SELECTOR, '.isgrP button')
